package com.example.inmobiliaria.util.geography;
...
import com.example.inmobiliaria.ui.property.AddPropertyActivity;
...
public class GeographySelectorFragment extends DialogFragment implements AdapterView.OnItemSelectedListener, DialogInterface.OnClickListener {
    ...
    public void setOnGeograpySelectedListener(AddPropertyActivity listener){
        this.gListener = listener;
    }

    public GeographySelectorFragment(Context context){
